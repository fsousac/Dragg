...
function useCarouselScrollButtons(api: CarouselApi) {
...
function useCarouselScrollActions(api: CarouselApi) {
...
function useCarouselContextValue({
  ...
  canScrollPrev,
  canScrollNext,
}: Omit<CarouselContextProps, 'orientation'> & { orientation: 'horizontal' | 'vertical' }) {
...
function useCarouselKeyboardNav(scrollPrev: () => void, scrollNext: () => void) {
...
function Carousel({
  ...
  const { canScrollPrev, canScrollNext } = useCarouselScrollButtons(api)
  const { scrollPrev, scrollNext } = useCarouselScrollActions(api)
  const handleKeyDown = useCarouselKeyboardNav(scrollPrev, scrollNext)
